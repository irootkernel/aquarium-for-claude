...
- Humanizer's complete payload is its root `SKILL.md` plus `LICENSE`, installed at `~/.claude/skills/humanizer`. Require `name: humanizer` and a v2 version matching the resolved tag.
