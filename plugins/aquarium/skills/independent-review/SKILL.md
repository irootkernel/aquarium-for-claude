...
argument-hint: "<epic-or-task-id>"
disable-model-invocation: true
---

# Independent Review

Coordinate one or more fresh reviewer subagents, preserve the current checkout, and independently verify the returned findings before recommending any response. This is a standalone review workflow, not the Mulgae phase owned by `/aquarium:task-review`.
...
Explicit invocation authorizes dispatching one or more read-only reviewer subagents. It does not authorize source edits, staging, commits, pushes, worktree creation, destructive actions, Mulgae, or remediation.
