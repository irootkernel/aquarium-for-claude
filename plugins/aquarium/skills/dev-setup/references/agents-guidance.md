...
When a repository says Mulgae requires an explicit request, clarify whether explicit `/aquarium:task-handler` invocation is the authorized task-scoped request; do not silently weaken the repository rule.
