...
- Native Claude Code receives the exact bounded candidate the current host can expose.
...
authoritative native target SHA-256. Orca, native Claude Code, and waiver evidence must
